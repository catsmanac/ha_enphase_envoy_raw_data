...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "custom_components.enphase_envoy_raw_data.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
async def mock_envoy(
    ...
    with (
        patch(
            "custom_components.enphase_envoy_raw_data.config_flow.Envoy",
            autospec=True,
        ) as mock_client,
        patch(
            "custom_components.enphase_envoy_raw_data.Envoy",
            new=mock_client,
        ),
        patch(
        ...
        aiohttp_read = AsyncMock()
        aiohttp_text.return_value = "Testing request \nreplies."
        aiohttp_read.return_value = b"Testing request \nreplies."
        mock.read = aiohttp_read
